...
export const DOSE_LOG_WINDOW_DAYS = 60;
...
export function dedupeActivePrescriptions(prescriptions) {
  const seen = new Set();
...
export function rolloverDate({ viewedDate, loadedToday, actualToday }) {
